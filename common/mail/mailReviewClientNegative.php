                ...
                <table style="width: 100% !important;border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="background: white;padding: 30px 35px;">
                            <h2 style="font-size: 28px;margin-bottom: 20px;line-height: 1.25;">Здравствуйте, <?= $reviewName ?></h2>
                            <p style="font-size: 16px;font-weight: normal;margin-bottom: 20px;">Мы благодарим Вас за Ваш отзыв!</p>
                            <p style="font-size: 16px;font-weight: normal;margin-bottom: 20px;">Мы обязательно свяжемся с Вами и вместе найдем выход из возникшей ситуации!</p>
                            <hr>
