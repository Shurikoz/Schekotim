...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">
            <a data-toggle="collapse" data-parent="#accordion" href="#create-update-visit">
                Создание нового/редактирование посещения
            </a>
        </h4>
    </div>
    <div id="create-update-visit" class="panel-collapse collapse">
        <div class="panel-body">
            <p>Размер ролика: 53.6Mb</p>
...
//                    'poster' => "http://www.videojs.com/img/poster.jpg",
                ...
                'tags' => [
                    'source' => [
                        ['src' => 'videos/tutorial/podolog/create-update-visit.mp4', 'type' => 'video/mp4']
                    ]
                ]
            ]); ?>
        </div>
