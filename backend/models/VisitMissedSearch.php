 ...
 */
class VisitMissedSearch extends Visit
{
    public $surname;
    public $name;
    public $middle_name;
    ...
    public function rules()
    {
        return [
            ...
            [['surname', 'name', 'middle_name', 'anamnes', 'manipulation', 'recommendation', 'next_visit_from', 'next_visit_by', 'visit_date', 'visit_time', 'description', 'timestamp', 'birthday'], 'safe'],
        ];
    }
    ...
    {
        $query = Visit::find()->where(['=', 'has_come', 2])->joinWith('card');
